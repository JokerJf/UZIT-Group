export const tariffsItem = [
  {
    ...
    services: [
      ...
      {
        img: './services/11.png',
        description: 'B2B Маркетинг',
      },
      {
        img: './services/12.png',
        description: 'Social Media Community управление',
      },
      {
        img: './services/13.png',
        description: 'Колл-цетнр услуги',
      },
      {
        img: './services/14.png',
        description: 'Ответы на комментарии личные письма',
      },
      {
        img: './services/17.png',
        description: 'E-commerce маркетинг',
      },
      {
        img: './services/20.png',
        description: 'Оригинал премиум контент',
      },
